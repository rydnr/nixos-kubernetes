      ...
      serviceConfig = {
        ExecStart = ''
          ${pkgs.coreutils}/bin/echo ${pkgs.kubernetes}/bin/kube-proxy \
              ...
              ${optionalString (cfg.config != null) "--config ${toString cfg.config}"} \
              ...
              ${optionalString (cfg.config.healthz-bind-address != null) "--config.healthz-bind-address ${toString cfg.config.healthz-bind-address}"} \
              ...
              ${optionalString (cfg.version != null) "--version ${toString cfg.version}"} \
