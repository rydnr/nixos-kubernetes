...
in
{
  ...
  config = mkIf cfg.enable {
    systemd.services.raw-kubernetes-ca = {
      ...
      # Ensure CA directory structure
      systemd.tmpfiles.rules = [
        "d '${cfg.caDirectory}' 0700 root root - -"
        "d '${cfg.caDirectory}/private' 0700 root root - -"
        "d '${cfg.caDirectory}/certs' 0755 root root - -"
        "d '${cfg.caDirectory}/crl' 0755 root root - -"
        "d '${cfg.caDirectory}/newcerts' 0755 root root - -"
      ];
