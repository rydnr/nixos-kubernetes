      ...
      serviceConfig = {
        ExecStart = ''
          ${pkgs.coreutils}/bin/echo ${pkgs.kubernetes}/bin/kube-apiserver \
            ...
            ${optionalString (cfg.watch-cache != null) "--watch-cache ${toString cfg.watch-cache}"} \
            ...
            ${optionalString (cfg.audit-log-batch-throttle-enable != null) "--audit-log-batch-throttle-enable ${toString cfg.audit-log-batch-throttle-enable}"} \
            ...
            ${optionalString (cfg.audit-webhook-batch-throttle-enable != null) "--audit-webhook-batch-throttle-enable         ${toString cfg.audit-webhook-batch-throttle-enable}"} \
            ...
            ${optionalString (cfg.anonymous-auth != null) "--anonymous-auth ${toString cfg.anonymous-auth}"} \
            ...
            ${optionalString (cfg.enable-bootstrap-token-auth != null) "--enable-bootstrap-token-auth ${toString cfg.enable-bootstrap-token-auth}"} \
            ...
            ${optionalString (cfg.service-account-extend-token-expiration != null) "--service-account-extend-token-expiration ${toString cfg.service-account-extend-token-expiration}"} \
            ...
            ${optionalString (cfg.service-account-lookup != null) "--service-account-lookup ${toString cfg.service-account-lookup}"} \
            ...
            ${optionalString (cfg.allow-privileged != null) "--allow-privileged ${toString cfg.allow-privileged}"} \
            ...
            ${optionalString (cfg.kubelet-preferred-address-types != null) "--kubelet-preferred-address-types \"${concatStringSep "," cfg.kubelet-preferred-address-types}\""} \
