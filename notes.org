...
#+begin_src nix :noweb tangle :exports none
enable = lib.mkOption {
  type = lib.types.bool;
  default = false;
  inherit description;
...
*** Outputs
#+BEGIN_SRC sh :tangle output1.txt :noweb tangle
<<foobar(foo="bar",bar="qux")>>
#+END_SRC

#+BEGIN_SRC sh :tangle output2.txt :noweb tangle
...
#+NAME: certificateModule
#+begin_src nix :var serviceName="replaceme" :noweb tangle :exports none
{
  config,
  pkgs,
  lib,
...
#+begin_src nix :noweb tangle :tangle kubernetes-ca.nix
{
  config,
  pkgs,
  lib,
...
#+begin_src nix :noweb tangle :tangle kube-proxy-certificate.nix
{
  config,
  pkgs,
  lib,
...
#+begin_src json :noweb tangle :tangle kube-proxy-kubeconfig
{
  "apiVersion": "v1",
  "clusters": [
    {
...
#+begin_src nix :noweb tangle :tangle kube-proxy.nix
{
  config,
  pkgs,
  lib,
...
#+begin_src nix :noweb tangle :tangle kubelet-certificate.nix
{
  config,
  pkgs,
  lib,
...
#+begin_src nix :noweb tangle :tangle kubelet.nix
{
  config,
  pkgs,
  lib,
...
First, the variables.
#+BEGIN_SRC nix :noweb tangle :tangle kube-apiserver.nix
{
  config,
  pkgs,
  lib,
...
#+begin_src nix :noweb tangle :tangle flake.nix
# flake.nix
#
...
#+BEGIN_SRC nix :noweb tangle :tangle kube-scheduler.nix
{
  config,
  pkgs,
  lib,
...
#+BEGIN_SRC nix :noweb tangle :tangle kube-controller-manager.nix
{
  config,
  pkgs,
  lib,
